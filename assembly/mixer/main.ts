...
import { bn128_f1m_square, bn128_g1m_double, bn128_frm_fromMontgomery, bn128_frm_toMontgomery } from "./websnark_bn128";
...
export function main(): i32 {
    ...
    debug_mem(input_data_buff as usize, SIZE_F);
    bn128_f1m_square(input_data_buff as usize, output);
