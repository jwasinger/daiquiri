...
function convertWebsnarkCallsInMainBN(mainWat) {
        let bnUsingBignumFuncs = mainWat;

        bnUsingBignumFuncs = bnUsingBignumFuncs.replace(/call \$websnark_bn128\/bn128_f1m_mul/g, "call \$main/bignum_f1m_mul");
        bnUsingBignumFuncs = bnUsingBignumFuncs.replace(/call \$websnark_bn128\/bn128_f1m_square/g, "call \$main/bignum_f1m_square");
        bnUsingBignumFuncs = bnUsingBignumFuncs.replace(/call \$websnark_bn128\/bn128_f1m_add/g, "call \$main/bignum_f1m_add");
        bnUsingBignumFuncs = bnUsingBignumFuncs.replace(/call \$websnark_bn128\/bn128_f1m_sub/g, "call \$main/bignum_f1m_sub");
...
function mergeAndWriteWasm(useBignumHostFuncs, finalFileName) {
    ...
    */
    ...
    if (useBignumHostFuncs) {
        mainWatReplaced = convertWebsnarkCallsInMainBN(mainWatReplaced);
    }
